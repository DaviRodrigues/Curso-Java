...
public class Listas {
	...
	public static void main(String[] args) {
		...
		list.add("Bob");
		list.add("Ana");
		// adicionando um elemento em local específico da lista (passa a posição, porém o que está naquela posição não desaparece)
		list.add(2, "Marco");
		...
		System.out.println("----------------------------");
		// list.remove("Ana"); // consegue remover tanto pelo valor, quanto consegue remover pelo index
